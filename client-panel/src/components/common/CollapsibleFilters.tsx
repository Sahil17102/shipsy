    ...
    <div className="w-full">
      ...
      <div className="lg:hidden">
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {extra && <div className="flex items-center gap-2 ml-auto flex-wrap">{extra}</div>}
        </div>
...
function MobileBottomSheet({
  ...
  return (
    <div className="fixed inset-0 z-[1000] flex flex-col justify-end" style={getThemeVarsStyle(mode)} data-theme={mode}>
      {/* Backdrop */}
      <div
        onClick={handleClose}
